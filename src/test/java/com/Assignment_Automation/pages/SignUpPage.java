...
public class SignUpPage extends BasePage{
	...
	private By emailsignin = By.xpath("//input[@id='email_create']");
	private By createAnAccount = By.xpath("//button[@id='SubmitCreate']");
	...
	public boolean registerUserInApp(boolean IsSignUpForNewsLetter, boolean IsspecialOfferEmailRegister)
	{
		...
		elementActions.doSendKeys(emailsignin, newUserEmailId);
		logger.info("Sending new user email id as : " + newUserEmailId);
		elementActions.doClick(createAnAccount);
